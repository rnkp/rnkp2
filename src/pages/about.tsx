  ...
  <App>
    <section className="about-page wrapper">
      ...
      <div className="box">
        ...
        <p>
          Создана для ликвидации пропасти между народом и властью и для разработки программы развития страны, обеспечивающей поступательное улучшение качества жизни и решение проблем высокого порядка общественной значимости.
        </p>
