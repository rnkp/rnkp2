  ...
  <section className="about-page wrapper">
    ...
    <div className="box">
      ...
      <div className="underline">
          ...
          <p>Основной принцип существования партии РНКП состоит в том, что задача правительства — делать для общества людей все то, что им нужно, но что сами они, выступая каждый в своем индивидуальном качестве, не могут сделать совсем или не могут сделать хорошо.</p>
      </div>
    </div>
  </section>
);
